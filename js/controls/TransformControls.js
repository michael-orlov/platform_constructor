...
( function () {
	...
	THREE.TransformControls = function ( camera, domElement ) {
        ...
        //
		//     if ( scope.object === undefined ) return;
		//     console.log("In rabbit hole");
		//     //sho - Add 2014/01/13 - set the gizmo at object center.
		//     if (!scope.object.boundingBox) {scope.object.geometry.computeBoundingBox();}
		//     scope.object.geometry.computeBoundingBox();
		//     var object_center = scope.object.geometry.boundingBox.max.clone().add(scope.object.geometry.boundingBox.min).multiplyScalar(1/2);
		//     var direction = object_center.clone().negate();
		//     var distance = direction.length();
        //
		//     direction.normalize();
		//     scope.object.translateOnAxis(direction, -distance);
        //
		//     //end
        //
		//     scope.object.updateMatrixWorld();
